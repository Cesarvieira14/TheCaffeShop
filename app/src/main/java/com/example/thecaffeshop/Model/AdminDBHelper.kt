...
class AdminDBHelper(context: Context) : SQLiteOpenHelper(context, DataBaseName, null, ver) {
    ...
    /* Customer Table */
    public val TableName = "Admins"
    public val Column_AdminId = "AdminId"
    public val Column_AdminFullName = "AdminFullName"
    public val Column_AdminEmail = "AdminEmail"
    public val Column_AdminPhoneNo = "AdminPhoneNo"
    public val Column_AdminUserName = "AdminUserName"
    public val Column_AdminPassword = "AdminPassword"
    public val Column_AdminIsActive = "AdminIsActive"
